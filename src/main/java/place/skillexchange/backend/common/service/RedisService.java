...
public class RedisService {
    ...
    public void writeClientRequest(String userId, Long talentId) {
        String key = generateKey(userId, talentId);
        log.debug("user post request key: {}", key);
    ...
    private String generateKey(String userId, Long talentId) {
        return userId + " + " + talentId;
    }
}
